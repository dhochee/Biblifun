namespace Biblifun.Common
{
    ...
    public interface IVerseParser
    {
        ...
        /// Will use the current  language of the BibleBookProvider if not specified.</param>
        ...
        VerseParseResult TryParseVerseString(string scriptureCitation, 
                                             out VerseSetDescriptor verseSet, 
        ...
        string GetVerseCitationText(VerseSetDescriptor verseSet, string language = null);
        ...
        /// Will use the current  language of the BibleBookProvider if not specified.</param>
        /// <returns>The language-specific citation, e.g. "1 Timothy 3:1-5"</returns>
        string GetVerseCitationText(string verseSetCode, string language = null);
        ...
        /// <param name="language">Optional language code identifier, such as "en" for English. 
        /// Will use the current  language of the BibleBookProvider if not specified.</param>
        string GetBookNameById(int bookId, string language = null);
    }
}